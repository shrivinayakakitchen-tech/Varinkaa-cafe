...
-   **Shopping Cart:** Add items to a cart, review your order in a slide-in panel, and adjust quantities easily.
-   **Seamless WhatsApp Integration:** Once you've selected your items, the cart generates a pre-filled WhatsApp message with your complete order and total price, ready to be sent.
...
4.  **Add Items to Your Order:**
    -   Click the **"Add"** button next to a dish to add it to your cart.
    -   Once an item is added, use the **`+`** and **`-`** buttons to adjust the quantity.
5.  **Place Your Order:**
    -   Click the **cart icon** in the top-right corner of the header to view your order.
    -   In the panel that appears, review your items and the grand total.
    -   When you are ready, click the **"Place Order on WhatsApp"** button. This will open WhatsApp with a message containing your order details, which you can send directly to the kitchen.
